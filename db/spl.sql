...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2023 at 05:46 PM
...
(1657, 'Kezia Mardhiyah', 'XI TKJ 2'),
(1675, 'Paulin Mayasari', 'X TKJ 1'),
(2246, 'Lala Nuraini', 'X TKJ 1'),
(2350, 'Qori Pudjiastuti', 'XI TKJ 1'),
(4676, 'Febiadi Wisnu Akbar', 'XII TKJ 1'),
(5424, 'Cayadi Natsir', 'XI TKJ 1'),
(7872, 'Laksana Simanjuntak', 'XII TKJ 2'),
(8735, 'Mala Puspita', 'XI TKJ 2');
...
--
ALTER TABLE `pemakaian`
  MODIFY `id_pemakaian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
